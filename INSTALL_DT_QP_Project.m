...
% required MATLAB File Exchange submissions, checks available solvers, 
...
%--------------------------------------------------------------------------
function INSTALL_DT_QP_Project
